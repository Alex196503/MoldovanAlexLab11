...
namespace Moldovan_Alex_Lab11.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ShopListsController : ControllerBase
    {
        private readonly Moldovan_Alex_Lab11Context _context;

        public ShopListsController(Moldovan_Alex_Lab11Context context)
        {
            _context = context;
        }
